...
public interface ReviewRepository extends JpaRepository<Review, Long>{
    ...
    // 영화번호를 기준으로 리뷰 조회
    // type = EntityGraphType.FETCH => FetchType.EAGER로 처리하고 나머지는 LAZY!
    // type = EntityGraphType.LOAD => FetchType.EAGER로 처리하고 나머지는 Entity 클래스에 명시된 방법 or 기본
    // @Transactional 말고 @EntityGraph로 처리하자
