...
public class BookServiceTest {
    ...
    public void testList(){
        PageRequestDTO dto = PageRequestDTO.builder().page(12).size(10).build();
    ...
    public void querydslTest2(){
        PageRequestDTO dto = PageRequestDTO.builder().page(1).size(10).type("t").keyword("파워").build();
        PageResultDTO<BookDTO> result = bookService.getList(dto);
        System.out.println(result.getDtoList());
        System.out.println("검색 결과 행 개수 "+ result.getTotalCount());
    }
}
